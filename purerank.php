<?php
    ...
    require_once('./include/db_info.inc.php');
        ...
        if(isset( $_GET ['start'] ))
                ...
                $sql = "SELECT `user_id`,`nick`,`solved`,`submit` FROM `users` WHERE `user_id` RLIKE '^team([0-9]|[1-7][0-9]|9[123])$' ORDER BY `solved` DESC,submit,reg_time  LIMIT  " . strval ( $rank ) . ",$page_size";
